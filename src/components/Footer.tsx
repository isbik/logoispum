...
export const Footer = (props: Props) => {
  return (
    <footer className="pb-16 grid grid-cols-12 gap-4 container mx-auto px-4">
      <div className="mt-8 md:mt-0 col-span-12 order-last md:-order-1 md:col-span-5">
        <div className="mb-8">
          <Image src={require("../assets/logo.png")} alt="logo" />
        </div>
        <p className="max-w-md mb-8 tex-gray-500">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab sed eum
          nulla ducimus nisi aliquam, ea minima architecto rerum saepe? Magni
          quasi aliquam sequi nemo vero, voluptatibus laborum sunt quo.
        </p>
        ...
        <div className="text-gray-500">© 2021 . All rights reserved.</div>
      </div>
      <div className="col-span-6 sm:col-span-4 md:col-span-2">
        <h4 className="mb-6 text-lg font-bold">Take a tour</h4>
      ...
      <div className="col-span-6 sm:col-span-4 md:col-span-2">
        <h4 className="mb-6 text-lg font-bold">Out company</h4>
        <ul className="flex flex-col gap-6">
          <li className="font-semibold">About us</li>
          <li className="font-semibold">Agents</li>
          <li className="font-semibold">Blog</li>
          <li className="font-semibold">Media</li>
          <li className="font-semibold">Contact Us</li>
        </ul>
      </div>
      <div className="col-span-12 sm:col-span-4 md:col-span-3">
        <h4 className="mb-6 text-lg font-bold">Our company</h4>

        <p className="max-w-xs mb-6 text-sm text-gray-500">
          Subscribe to get latest property, blog news from us
        </p>

        <div className="flex items-center justify-between p-2 px-4 rounded-xl border-2 border-gray-500">
          <input
            placeholder="Email Address"
            className="w-full h-full outline-none bg-transparent"
            type="text"
          />
          <button className="flex items-center justify-center bg-blue-500 rounded-full w-8 h-8 aspect-square">
            <svg
              width="13"
              height="14"
              viewBox="0 0 13 14"
            ...
            >
              ...
              />
              <path
                d="M6.5 1.9292L12 7.28658L6.5 12.644"
                stroke="white"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
